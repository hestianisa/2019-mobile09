...
import com.example.tugas2.adapters.MinionKuningAdapter;
import com.example.tugas2.models.MinionKuning;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvMinion.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
    }
}
